...
thank_you_responses = [
    "Не за что, браток! Обращайся, всегда что-нибудь прикольное подкину для 😎🤙",
    "Всегда рад помочь, мужичек! Если что, зови раскумаримся 🙌💥",
    "Да ладно, не за что! Когда нужно, всегда на связи, как всегда! 👊😜",
    "Не за что, братка! Зови в любой момент, накурим что-то интересное! 🎯😎",
    "Обращайся, вообще не вопрос! Все всегда по кайфу помочь такому уважаемому челику! 🖤✨",
    "Вижу, что оценил! Респект! жму руку, обнимаю! 👏🔥",
    "Не за что, дружище! Когда нужно — всегда подкину что-то не нужное ! 👌💪",
    "Да не вопрос, братка! Если нужно — пиши, всегда чем-то подвыручу! ✌️😉"
]
