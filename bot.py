...
thank_you_responses = [
    ...
    "Всегда рад помочь, дружище! Если что, зови раскумаримся 🙌💥",
    "Да ладно, не за что! если че звони оттопыримся! 👊😜",
    ...
    "Вижу, что оценил! Респект! Жму руку, обнимаю! 👏🔥",
    "Не за что, дружбанчик! Когда нужно — всегда подкину какой нибудь херни👌💪",
    "Да не вопрос, браток! Если нужно — пиши, всегда чем-то подвыручу! ✌️😉",
...
bad_words_responses = [
    ...
    "Не сдержался, брат? Давай без этого здесь же дети! 🙄",
    "Вот это я понимаю — сказанул так сказанул! 😅",
    "Эх, прям не по-людски! +30 минут за маты 🤦‍♂️",
    "Как так можно? Неуважительно! иди на холодку 😤",
    "Ну обойдись ты без мата! я тоже человек, мне не приятно это слышать блин 🙅‍♂️",
    "Не надо так! Мало ли дети читают...👀",
