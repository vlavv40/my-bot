...
thank_you_responses = [
    ...
    "Всегда рад помочь, бро! Если что, зови, не стесняйся! 🙌💥",
    "Не за что, красавчик! Пришлю что-нибудь эпичное в следующий раз! 😏🔥",
    "Да ладно, не за что! Когда нужно, всегда на связи, как всегда! 👊😜",
    "Не за что, брат! Зови в любой момент, накурим что-то интересное! 🎯😎",
    "Обращайся, вообще не вопрос! Все всегда по кайфу! 🖤✨",
    "Вижу, что оценил! Респект! Жду тебя снова! 👏🔥",
    "Не за что, дружище! Когда нужно — всегда подкину что-то прикольное! 👌💪",
    "Да не вопрос, братан! Если нужно — пиши, всегда чем-то придумаю! ✌️😉",
    "Всегда рад! Зови, если что, будем творить чудеса! 💥🚀"
]
